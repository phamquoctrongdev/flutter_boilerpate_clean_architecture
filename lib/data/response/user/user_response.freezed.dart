...
class _$UserResponseImpl implements _UserResponse {
  const _$UserResponseImpl(
      ...
      @JsonKey(name: 'data') final List<User> users = const []})
      : _users = users;
  ...
  @override
  String toString() {
    return 'UserResponse(currentPage: $currentPage, lastPage: $lastPage, perPage: $perPage, total: $total, users: $users)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, currentPage, lastPage, perPage,
      total, const DeepCollectionEquality().hash(_users));
...
abstract class _UserResponse implements UserResponse {
  const factory _UserResponse(
      ...
      @JsonKey(name: 'data') final List<User> users}) = _$UserResponseImpl;
